odoo.define('mail_broker/static/src/components/discuss/discuss_tests.js', function (require) {
'use strict';
...
QUnit.module('mail_broker', {}, function () {
...
QUnit.test('Broker in the sidebar: basic rendering', async function (assert) {
    assert.expect(5);
...
//        livechat_operator_id: this.data.currentPartnerId,
    ...
    assert.strictEqual(
        ...
        "Broker Channel",
        "should have a channel group named 'Broker Channel'"
    );
